		...
		<div class="container">
			...
			<div class="list" style="width: 500px;">
				<div class="text-box">
					...
					<input type="text" class="signin-input" id="name_profile" name="name_profile" style="height: 38px; padding: 15px 18px;">
				</div>

				<br>
				<div class="text-box">
					<p style="font-weight: bold; margin: 0 0 8px;">Email Address</p>
					<input type="text" class="signin-input" id="email_profile" name="email_profile" style="height: 38px; padding: 15px 18px;">
				</div>

				<br>
				<div class="text-box">
					<p style="font-weight: bold; margin: 0 0 8px;">Mobile number</p>
					<input type="text" class="signin-input" id="mobile_profile" name="mobile_profile" style="height: 38px;  padding: 15px 18px;">
				</div>
				...
				<div class="text-box">
					...
					<input type="text" class="signin-input" id="birthday_profile"
						name="birthday_profile" style="height: 38px; padding: 15px 18px;">
				</div>
				...
				<div class="text-box">
					...
					<option value="31">여</option>
					<option value="31">선택 안함</option>
					</select>
