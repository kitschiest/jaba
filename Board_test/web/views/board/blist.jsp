...
<body>
	<div>
		<p>driver1.get("https://www.iei.or.kr/login/login.kh​");</p>
		<table border="1">
			<tr>
		...
		%>
		<a href="blist.jsp?pageNum=<%=startPage - pageBlock%>">[이전]</a>
		<%
			}
		...
		if (startPage < pageBlock) {
		%>
		<a href="blist.jsp?pageNum=<%=startPage + pageBlock%>">[다음]</a>
		<%
			}
		}
		%>
