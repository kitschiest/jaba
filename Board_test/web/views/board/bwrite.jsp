...
%>
	<p>글쓰기</p>
	<form method="post" action="<%=request.getContextPath()%>/boardInsert.lo" onsubmit="return writefrm_submit();">
		...
		<table border="1">
			<tr>
				<td colspan="2"><a href="blist.jsp">글목록</a></td>
			</tr>
			<tr>
				<td>작성자ID</td>
			...
			<tr>
				<td>파일선택</td>
				<td><input type="text" name ="bfilepath" id="bfilepath"></td>
			</tr>
			<tr>
				<td>비밀번호</td>
			...
			<tr>
				<td colspan="2">
					...
					<input type="button" value="글목록" onclick="window.location='blist.jsp'">
				</td>
			</tr>
		</table>
